...
namespace CoCoME.Terminal.CardReaderService
{
    ...
    public class AuthorizeRequestDto : Tecan.Sila2.ISilaTransferObject, Tecan.Sila2.ISilaRequestObject
    {
        ...
        public AuthorizeRequestDto(int amount, byte[] challenge, Tecan.Sila2.IBinaryStore store)
        {
    ...
    public class AuthorizationDataDto : Tecan.Sila2.ISilaTransferObject<AuthorizationData>
    {
        ...
        {
            return new AuthorizationData(((int)(Amount.Extract(store))), Account.Extract(store), AuthorizationToken.Extract(store));
        }
