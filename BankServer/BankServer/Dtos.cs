...
namespace BankServer.BankServer
{
    ...
    public class CreateContextRequestDto : Tecan.Sila2.ISilaTransferObject, Tecan.Sila2.ISilaRequestObject
    {
        ...
        public CreateContextRequestDto(int amount, Tecan.Sila2.IBinaryStore store)
        {
    ...
    public class TransactionContextDto : Tecan.Sila2.ISilaTransferObject<TransactionContext>
    {
        ...
        {
            return new TransactionContext(ContextId.Extract(store), Challenge.ExtractToBytes(store), ((int)(Amount.Extract(store))));
        }
